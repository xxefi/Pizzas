    ...
    public UpdateAddressValidator(ILocalizationService ls)
    {
        RuleFor(a => a.Street)
            ...
            RuleFor(a => a.Country)
                ...
                .Must(IsValidCountry)
                .WithMessage(_ => ls.GetLocalizedString("CountryInvalid"))
            ...
            RuleFor(a => a.PostalCode)
                ...
                .WithMessage(_ => ls.GetLocalizedString("PostalCodeInvalid"))
                .MaximumLength(MaxPostalCodeLength)
                .WithMessage(_ => string.Format(ls.GetLocalizedString("PostalCodeMaxLength"), MaxPostalCodeLength));
    }
} 